...
test.describe('Admin Login Page', () => {
  ...
  test('SPN - should load admin login page', async ({ page }) => {
    ...
    await expect(adminLoginPage.adminLoginTitleSpanish()).toHaveText(
      'Acceso Admin'
    );
  });

  test('should login with valid credentials and show toast notification', async ({
    page,
  }) => {
  ...
  // Negative tests
  test('should deny login with invalid credentials and show toast notification', async ({
    page,
  }) => {
